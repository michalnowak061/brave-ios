...
extension Strings {
    ...
    public static let hideStatusBar = NSLocalizedString("HideStatusBar", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Hide Status Bar while scrolling", comment: "Hides system Status Bar")
